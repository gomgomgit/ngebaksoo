                  ...
                  <td class="px-4 py-3 text-sm">
                      <div class="flex items-center gap-4">
                          ...
                          <form id='deleteMenu{{$user->id}}' method="POST" action="{{ route('user.delete', $user->id) }}">
                            @csrf
                            <button @click="deleteUser" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-full active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red" aria-label="delete">
      ...
      <div class="mt-4 mb-6">
        ...
        <div>
          <label class="block text-sm">
            ...
            <input name="username" :value="dataUser.username" class="text-gray-700 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Username">
          </label>
        </div>
        <div>
          <label class="block text-sm">
