        ...
        <form action="{{route('client.checkout')}}" method="POST">
            ...
            <div class="mt-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex h-full rounded-xl overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <div class="h-full">
                                        <form class="delete-cart h-full" action="{{route('client.delete.cart')}}" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$cart->id}}" />
                ...
                <div class="mt-3">
                    ...
                    <div>
                        <textarea required name="address" class="p-2 w-full rounded-lg border-2 border-green-500" rows="4"></textarea>
                    </div>
                </div>
    ...
    function init() {
      ...
      return {
        ...
        deleteCart(event, callback) {
            ...
            let form = event.target.closest('form.delete-cart')
            Swal.fire({
